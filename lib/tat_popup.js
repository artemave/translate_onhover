class TatPopupTransover extends HTMLElement {
  ...
  constructor() {
    ...
    const sendTranslate = () => {
      ...
      localStorage.tat_popup_to_lang = this.q('#tat_to_lang').value
      localStorage.tat_popup_from_lang = this.q('#tat_from_lang').value
  ...
  attributeChangedCallback(attribute, oldVal, newVal) {
    if (attribute == 'data-languages') {
      ...
      if (localStorage.tat_popup_from_lang) {
        select_auto = false
        this.q('#tat_from_lang').value = localStorage.tat_popup_from_lang
      }
      if (localStorage.tat_popup_to_lang) {
        select_auto = false
        this.q('#tat_to_lang').value = localStorage.tat_popup_to_lang
      }
